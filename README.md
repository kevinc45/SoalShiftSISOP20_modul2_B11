...
Hal yang sama kita lakukan saat akan men-*delete* folder yang sudah selesai di-*zip*.  Oleh karena itu, kami akan menggunakan ```while(wait(&status)>0)```
...
Belum Berhasil  
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTQxMTkzNTczLC00MzA1Njk5ODEsOTAxMD
MzNzkwXX0=
-->